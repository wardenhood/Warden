...
function isBlockedIPv4(ip) {
    ...
    if (a === 127)
        return true; // 127.0.0.0/8 loopback (covers 127.0.0.2 etc, not just 127.0.0.1)
    if (a === 10)
    ...
    if (a === 100 && b >= 64 && b <= 127)
        return true; // 100.64.0.0/10 CGNAT <- the missed range
    if (a === 192 && b === 0 /* 192.0.0.0/24, 192.0.2.0/24 etc. */)
        return true;
    if (a === 198 && (b === 18 || b === 19))
 ...
 */
export async function safeFetch(inputUrl, options = {}, redirectCount = 0) {
